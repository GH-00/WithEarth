...
public class StoreActivityCart extends AppCompatActivity {
    ...
    private StoreActivityCartUnlogin activity_store_cart_unlogin;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (auth.getCurrentUser() != null) {
            ...
            activity_store_cart_unlogin = new StoreActivityCartUnlogin();
            Intent intent = new Intent(StoreActivityCart.this, StoreActivityCartUnlogin.class);
            startActivity(intent);
            finish();
